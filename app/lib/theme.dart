...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff5e4157),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff78586f),
      onTertiaryContainer: Color(0xfffbd2ed),
      ...
      onTertiaryFixed: Color(0xff2b1326),
      tertiaryFixedDim: Color(0xffe3bbd6),
      onTertiaryFixedVariant: Color(0xff5b3d53),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryFixed: Color(0xff84637b),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff6a4b62),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff3e2338),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff5e4056),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff5e4056),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff452a3f),
      onTertiaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xff141b41),
      onSecondaryContainer: Color(0xff7d83b0),
      tertiary: Color(0xffe3bbd6),
      onTertiary: Color(0xff43283c),
      tertiaryContainer: Color(0xff78586f),
      onTertiaryContainer: Color(0xfffbd2ed),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xfffad1ec),
      onTertiary: Color(0xff371d31),
      tertiaryContainer: Color(0xffaa869f),
      ...
      tertiaryFixed: Color(0xffffd7f1),
      onTertiaryFixed: Color(0xff20081c),
      tertiaryFixedDim: Color(0xffe3bbd6),
      onTertiaryFixedVariant: Color(0xff492d42),
      surfaceDim: Color(0xff131313),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffdfb7d2),
      onTertiaryContainer: Color(0xff190415),
      ...
      tertiaryFixedDim: Color(0xffe3bbd6),
      onTertiaryFixedVariant: Color(0xff20081c),
      surfaceDim: Color(0xff131313),
